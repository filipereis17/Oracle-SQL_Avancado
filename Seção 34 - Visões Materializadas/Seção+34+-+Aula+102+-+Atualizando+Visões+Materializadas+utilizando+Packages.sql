...
-- Passando system privilÃ©gios necessário para executar componentes da package DBMS_MVIEW

GRANT EXECUTE ON DBMS_MVIEW to hr;

-- Passando system privilÃ©gios necessário para executar componentes da package DBMS_SNAPSHOT
